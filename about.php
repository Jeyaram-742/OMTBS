  ...
  <body>
    ...
    <section class="showtime_page">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p style="font-size: 3vw; font-weight: bold;text-align: center;">Movie Ticket is build For Mini project.
            </p>
			<h5 style="font-size: 3vw;font-weight: bold;text-align: center;color: blueviolet;">We are movie buffs</h5>
			<p><b style="color: blue;">Developer Contact</b></p>
			<p><b>Email:</b> jramjram742@gmail.com</p>
			<p><b>Address:</b> KLN College Of Engineering</p>
          </div>
        </div>
      </div>
    </section>
